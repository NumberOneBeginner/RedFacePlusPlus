...
//        setBackgroundColor(0x00000000);
        setBackgroundColor(getResources().getColor(R.color.whiter));
...
//        mContainerHeader.setBackgroundColor(0xffdedede);
        mContainerHeader.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
...
//        mHeadeBottomLeft.setTextColor(mBottomColor);
        mHeadeBottomLeft.setTextColor(getResources().getColor(R.color.whiter));
        mHeadeBottomLeft.setText("Cancel");
...
//        mHeaderBottomRight.setTextColor(mBottomColor);
        mHeaderBottomRight.setTextColor(getResources().getColor(R.color.whiter));
        mHeaderBottomRight.setPadding((int) (density*8), (int) (density*8), (int) (density*8), (int) (density*8));
        mHeaderBottomRight.setText("Done");
                ...
                case AbsListView.OnScrollListener.SCROLL_STATE_IDLE:
                    ...
                    if (viewTop.getTop() < 0) {
                        if (Math.abs(viewTop.getTop()) > viewTop.getHeight()/2) {
                            ((ListView)view).setSelection(view.getFirstVisiblePosition()+view.getChildCount()-1);
//                            ((ListView)view).smoothScrollToPosition(view.getFirstVisiblePosition()+view.getChildCount()-1);
                        } else {
                            ((ListView)view).setSelection(view.getFirstVisiblePosition());
    ...
    private void setText(){
        if (mListener != null) {
            ...
            for (int i = 0 ; i<mTimeView.size(); i++) {
                ...
                time= time.replaceAll("year","/");
                time= time.replaceAll("month","/");
                time= time.replaceAll("day"," ");
                time= time.replaceAll("hour",":");
                time= time.replaceAll("minute","");
            }
